      ...
      <div className="auth-container">
        ...
        <div className="auth-card glass-card">
          ...
          <div className="auth-socials">
            <button type="button" className="auth-social-btn" onClick={() => setGoogleSoon(true)}>
          ...
          {googleSoon && (
            <div style={{ marginTop: 12, fontSize: 13, fontWeight: 600, textAlign: 'center', color: '#F26522', background: 'rgba(242,101,34,0.08)', border: '1px solid rgba(242,101,34,0.25)', borderRadius: 8, padding: '10px 14px' }}>
